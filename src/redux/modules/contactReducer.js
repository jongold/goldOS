  ...
  threads: [
    { title: '#fulltime',
      messages: [
        { text: '😍' },
        { text: '😍', me: true },
        { text: 'So we’re hiring and we thought you’d be a great fit…' },
        { text: 'tell me more!', me: true },
        { text: 'well, we’re a diverse, well-funded team in London, Berlin, San Francisco or Portland working on something interesting. Our design team is full of weird hybrids like you, too!' },
